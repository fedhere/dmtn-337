...
The set of weights that generate the reliability score has been updated three times; for each update, the model architecture remains the same, but a different dataset was used. Each version of the reliability model is detailed in \autoref{tab:model_version}.
\begin{table}[htb!]
    \centering
